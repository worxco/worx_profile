 ...
 */
function worx_commerce1_profile_modules() {
  return array(
    // General modules
    ...
    // Php format needed so that Footer Mesage block can have php code for the year, site name, and login/logout.
    'php', 
		//Ubercart and all modules
		'uc_cart', 'ca', 'uc_order', 'uc_product', 'uc_store', 'uc_payment', 'uc_reports', 'uc_taxes', 'uc_flatrate', 
  );
}
 ...
 */
function worx_commerce1_profile_details() {
  return array(
    'name' => 'Worx Commerce',
 ...
 *   task list.
 */
function worx_commerce1_profile_task_list() {
}
 ...
 */
function worx_commerce1_profile_tasks(&$task, $url) {
 ...
 */
function worx_commerce1_form_alter(&$form, $form_state, $form_id) {
